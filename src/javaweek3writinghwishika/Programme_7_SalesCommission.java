package javaweek3writinghwishika;
...
public class Programme_7_SalesCommission {
    public static void main(String[] args) {
        ...
        System.out.println("Seller id is            : " + name);
        System.out.println("Seller's sales amount is            : " + name);
        System.out.println("Seller's basic salary is             : " + name);
        System.out.println("Seller's gross salary is           : " + name);
